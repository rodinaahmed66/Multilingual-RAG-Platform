...
Revision ID: 96f850c1c198
Revises: 
Create Date: 2026-06-16 16:45:17.057804
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunk_type', 'chunks', ['chunk_asset_id'], unique=False)
